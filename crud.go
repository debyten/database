...
type ConditionArg interface {
	Condition() string
	JoinArgs(initial []any) []any
}
type QueryClauses map[string]ConditionArg
...
type Crud[T any, ID comparable] interface {
	...
	Delete(ctx context.Context, entity *T, query ...QueryClauses) error
	...
	Count(ctx context.Context, query ...QueryClauses) (int64, error)
	...
	FindPage(ctx context.Context, offset, size int, query ...QueryClauses) ([]T, error)
	FindByID(ctx context.Context, id ID) (*T, error)
	FindOneBy(ctx context.Context, query ...QueryClauses) (*T, error)
	FindBy(ctx context.Context, query ...QueryClauses) ([]T, error)
	ExistsByID(ctx context.Context, id ID) (bool, error)
	ExistsBy(ctx context.Context, query ...QueryClauses) (bool, error)
	...
	MustExistBy(ctx context.Context, query ...QueryClauses) error
}
